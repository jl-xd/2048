module validator {
	 ...
	 * @name func
	 * @noSelf */
	export let validator_183513391:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 初始点: Point | undefined = AI.params.get("__ai_born");
		// 超出最大距离就回初始点
	 ...
	 * @name func
	 * @noSelf */
	export let validator_143332637:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
			...
			if (((AI.unit.has_module(_OBJ__UnitData_Module["移动"]) == true))) {
				if (((目标单位.is_alive_ex() == true))) {
					...
					if ((((AI.unit.get_scene_point().get_scene() == 目标点.get_scene()) && (AI.unit.get_scene_point().distance(目标点) > (AI.attack_range + 目标单位.cache.AttackableRadius)) && (目标点.is_block() == false) && (要施放的技能 == undefined)))) {
						AI.unit.approach(目标单位, (AI.attack_range + 50), AI.attack_range);
						移动指令目标点 = AI.unit.get_walking_target();
						if ((((移动指令目标点 != undefined) && (移动指令目标点.get_scene() == 目标点.get_scene()) && (移动指令目标点.distance(目标点) > 50)))) {
							AI.unit.clean_command();
							AI.unit.stop();
							AI.params.set("__ai_battle_walk_target", undefined);
						} else {
	 ...
	 * @name func
	 * @noSelf */
	export let validator_21039145:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
	 ...
	 * @name func
	 * @noSelf */
	export let validator_35809766:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 初始点: Point | undefined = AI.params.get("__ai_born");
	 ...
	 * @name func
	 * @noSelf */
	export let validator_142664175:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 初始点: Point | undefined = AI.params.get("__ai_born");
		let 目标: Unit | undefined = AI.params.get("__ai_target");
		let 追逐距离: number = AI.unit.get_ex(单位属性["追逐距离"], UnitPropertySubType["Final"]);
	 ...
	 * @name func
	 * @noSelf */
	export let validator_148316066:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 目标: Unit | undefined = AI.params.get("__ai_target");
	 ...
	 * @name func
	 * @noSelf */
	export let validator_78956949:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
	 ...
	 * @name func
	 * @noSelf */
	export let validator_152492802:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		...
		if (((AI.unit.has_module(_OBJ__UnitData_Module["移动"]) && (战斗移动点 != undefined)))) {
			if (((AI.unit.get_scene_point().get_scene() == 战斗移动点.get_scene()))&&((AI.unit.get_scene_point().distance(战斗移动点) > (AI.attack_range + 128)))&&((战斗移动点.is_block() == false))&&((要施放的技能 == undefined))) {
				AI.unit.approach(战斗移动点, (AI.attack_range + 128), AI.attack_range);
				return true;
			} else {
				AI.params.set("target_point_battle", undefined);
			}
	 ...
	 * @name func
	 * @noSelf */
	export let validator_85422483:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 目标: Unit | undefined = AI.params.get("target_unit");
	 ...
	 * @name func
	 * @noSelf */
	export let validator_264272465:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 目标点: Point | undefined = AI.params.get("target_point");
		...
		if (((AI.unit.get_scene_point().get_scene() == 目标点.get_scene()))&&((AI.unit.get_scene_point().distance(目标点) < 50))&&((AI.params.get("target_unit") == undefined))) {
	 ...
	 * @name func
	 * @noSelf */
	export let validator_65391929:(this: void, AI:lib_common_ai.AI)=>void = (this: void, AI:lib_common_ai.AI):void => {
	 ...
	 * @name func
	 * @noSelf */
	export let validator_216613112:(this: void, AI:lib_common_ai.AI)=>boolean = (this: void, AI:lib_common_ai.AI):boolean => {
		let result: boolean = false;
		let 战斗移动点: Point | undefined = AI.params.get("order_move");
		let 要施放的技能: Skill | undefined = AI.params.get("next_skill");
		if (((AI.unit.has_module(_OBJ__UnitData_Module["移动"]) && (战斗移动点 != undefined)))) {
			if (((AI.unit.get_scene_point().get_scene() == 战斗移动点.get_scene()))&&((AI.unit.get_scene_point().distance(战斗移动点) > 50))&&((战斗移动点.is_block() == false))) {
				AI.unit.walk(战斗移动点);
				return true;
			} else {
	...
	function init_validator_0() {
		...
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_2")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_183513391(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_3")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_143332637(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_4")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_21039145(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_5")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_35809766(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_6")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_142664175(...args); return result; }
		}
		...
		if (data = base.eff.cache("$$spark_core.ai.testai.default_units_ts_AIBehavior_8")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_148316066(...args); return result; }
		}
		...
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior_1")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_78956949(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior_2")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_152492802(...args); return result; }
		}
		...
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior_6")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_85422483(...args); return result; }
		}
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.AIBehavior_7")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_264272465(...args); return result; }
		}
		...
		if (data = base.eff.cache("$$spark_core.ai.沿路线前进ai.root")) {
			data.OnAdd = (this: void, ...args: any) => { let result = validator_65391929(...args); return result; }
		...
		if (data = base.eff.cache("$$spark_core.ai.自定义AI样例.AIBehavior_2")) {
			data.Behavior = (this: void, ...args: any) => { let result = validator_216613112(...args); return result; }
		}
		...
		if (data = base.eff.cache("$$.gameplay.dflt.default_units_ts_LeechRule")) {
			data.FLeechRule = (this: void, ...args: any) => { let result = validator_232912629(...args); return result; }
		}
		if (data = base.eff.cache("$$.gameplay.dflt.root")) {
			...
			data.FProtoRequest = (this: void, ...args: any) => { let result = validator_190375280(...args); return result; }
			data.FProtoStopRequest = (this: void, ...args: any) => { let result = validator_255226058(...args); return result; }
		}
	...
	function init_validator_1() {
		...
		if (data = base.eff.cache("$$default_units_ts.spell.不死鸟灼伤.PersistLoop_1_1")) {
			data.PersistValidator = (this: void, ...args: any) => { let result = validator_258945007(...args); return result; }
		}

...
internal class TestTriggers : IGameClass
{
    ...
    private static Trigger<EventEntityOrderStage>? heroSkillTrigger;
    private static Trigger<EventEffectExecuted>? effectExecutedTrigger;
    private static Trigger<EventEntityDeath>? deathTrigger;
    private static Trigger<EventEntityOrderStage>? passiveSkillTrigger;
    private static Trigger<EventEntityDamageTaken>? heroDamageTrigger;
    private static Trigger<EventPlayerKeyDown>? keyTrigger;
...
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
    ...
    private static void SpawnMonstersAroundHero(Scene scene, Unit hero)
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            float distance = 500f + random.NextSingle() * 300f;
